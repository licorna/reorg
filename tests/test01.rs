...
//     assert_eq!(heading.unwrap().stars, 1);
// }

// #[test]
// fn get_correct_starts() {
//     let h1 = reorg::build_heading("* 1 star".to_string()).unwrap();
//     assert_eq!(h1.stars, 1);
//     assert_eq!(h1.title, "1 star");

//     let h2 = reorg::build_heading("** 2 stars".to_string()).unwrap();
//     assert_eq!(h2.stars, 2);
//     assert_eq!(h2.title, "2 stars");

//     let h3 = reorg::build_heading("*** 3 stars".to_string()).unwrap();
...
// #[test]
// fn finds_todo_item() {
//     let h1 = reorg::build_heading("* TODO something".to_string()).unwrap();
...
// #[test]
// fn finds_done_item() {
//     let h2 = reorg::build_heading("* DONE something".to_string()).unwrap();
...
// #[test]
// fn finds_no_keyword() {
//     let h3 = reorg::build_heading("* nope something".to_string()).unwrap();
...
//     let entry = reorg::build_entry(text).unwrap();
...
// * Heading number 2
// And some other unnecessary text
// ok, bye.


// ".to_string();
//     let doc = reorg::build_document(doc, 1).unwrap();

//     assert_eq!(doc.entries[0].heading.title, "This is a document");
//     assert_eq!(doc.entries[0].heading.stars, 1);
//     assert_eq!(doc.entries[0].content.len(), 4);

//     assert_eq!(doc.entries[1].heading.title, "Heading number 2");
//     assert_eq!(doc.entries[1].heading.stars, 1);
//     assert_eq!(doc.entries[1].content.len(), 5);
// }
